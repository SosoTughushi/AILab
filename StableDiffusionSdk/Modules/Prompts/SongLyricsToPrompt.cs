...
the content of the lyrics. Note that the prompts are independent, and no information will carry from one prompt to another. Please provide your response as a 
